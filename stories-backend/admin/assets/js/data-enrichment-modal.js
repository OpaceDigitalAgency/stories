    ...
    function updateEnrichmentDataWithAmazon(amazonData) {
        ...
        if (window.currentEnrichmentData && window.currentEnrichmentData.fields) {
            ...
            Object.keys(amazonData).forEach(fieldName => {
                ...
                if (fieldName === 'tags') {
                    console.log(`📦 AMAZON_DEBUG: Skipping tags field entirely - Amazon doesn't provide meaningful tags data and causes display issues`);
                    return; // Skip tags field completely
                }
