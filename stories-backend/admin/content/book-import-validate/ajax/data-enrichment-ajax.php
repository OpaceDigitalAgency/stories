...
function handleGetEnrichmentData() {
    ...
    try {
        ...
        // CRITICAL FIX: Amazon data is already merged in combineMultiSourceData function
        // Remove duplicate Amazon merging to prevent duplicate source options
        error_log("AMAZON_MERGE: Amazon data already included in combineMultiSourceData - skipping duplicate merge");
