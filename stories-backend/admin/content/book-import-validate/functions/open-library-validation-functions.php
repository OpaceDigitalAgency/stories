            ...
            if (!empty($data['docs'])) {
                foreach ($data['docs'] as $doc) {
                    ...
                    $suggestions[] = [
                        ...
                        'language' => !empty($doc['language']) ? implode(', ', $doc['language']) : '',
                        'format' => !empty($doc['format']) ? implode(', ', $doc['format']) : (!empty($doc['type']) ? $doc['type'] : ''),
                        'cover_url' => $coverUrl,
                        'preview_link' => !empty($doc['ia']) ? "https://archive.org/details/" . $doc['ia'][0] : '',
                        'summary' => $doc['first_sentence'] ?? '',
                        'subjects' => $doc['subject'] ?? [],
                        'subject_facet' => $doc['subject_facet'] ?? [],
                        'subject_key' => $doc['subject_key'] ?? [],
                        'place' => $doc['place'] ?? [],
                        'place_facet' => $doc['place_facet'] ?? [],
                        'person' => $doc['person'] ?? [],
                        'person_facet' => $doc['person_facet'] ?? [],
                        ...
                        'ia_collection' => $doc['ia_collection'] ?? [],
