...
$pageTitle = 'Check Fetcher Files';
$currentPage = 'check-fetchers';
$pageDescription = 'Check if all the required fetcher files exist and are accessible';
...
$pageActions = '
<div class="btn-group">
    <a href="check-fetchers.php" class="btn btn-primary">
        <i class="fas fa-arrow-left"></i> Back to Test Fetchers
    </a>
