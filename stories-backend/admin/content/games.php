...
try {
    ...
    error_log("Games page PDO error: " . $e->getMessage());
    $error = "Database error loading games data: " . $e->getMessage();
    ...
    error_log("Games page general error: " . $e->getMessage());
    $error = $e->getMessage();
}
