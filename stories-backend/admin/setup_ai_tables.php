...
if (basename($_SERVER['PHP_SELF']) === basename(__FILE__)) {
    ...
    try {
        ...
        echo "AI tables installed successfully!";

    } catch (PDOException $e) {
        echo "Error installing AI tables: " . $e->getMessage();
    }
}

// The SQL is also available in the $sql variable if this file is included elsewhere
?>
...
<body>
    ...
    <div class="options">
        <h2>Options:</h2>
        <p>
            <a href="?install=1" class="button">Install Tables</a>
    ...
    <div class="instructions">
        <h2>Instructions:</h2>
        <ol>
            <li>Click "Install Tables" to automatically create the tables in your database</li>
