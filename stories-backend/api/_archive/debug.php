 ...
 * API Debug Script
 *
 * This script displays debugging information for the API.
 */
...
if (file_exists($errorLogFile) && is_readable($errorLogFile)) {
    ...
    echo "<p>Error log file not found or not readable: " . htmlspecialchars($errorLogFile) . "</p>";
    ...
    foreach ($commonLogLocations as $logFile) {
        if (file_exists($logFile) && is_readable($logFile)) {
            echo "<p>Found log file: " . htmlspecialchars($logFile) . "</p>";
