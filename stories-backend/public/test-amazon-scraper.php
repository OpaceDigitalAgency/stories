<?php
/**
 * Test Amazon Review Scraper (Web Version)
 *
 ...
 *
 * Usage:
 * /test-amazon-scraper.php?isbn=9780007416851&limit=20
 */
...
try {
    ...
    if (!$isbn) {
        die("Usage: /test-amazon-scraper.php?isbn=9780007416851&limit=20\n");
    }
