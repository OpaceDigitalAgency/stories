...
class OutscraperClient {
     ...
     * @param string $sort Sorting order (e.g., 'newest')
     * @param string $domain Amazon domain (e.g., 'com', 'co.uk')
     * @param bool $async Whether to run the request asynchronously
     * @return array Response data
     */
    public function amazon_reviews($query, int $limit = 10, string $sort = 'newest', string $domain = 'com', bool $async = false) : array {
