...
/**
 * Database Connection Include for Tests
 *
 * This file establishes a connection to the database for test scripts.
 * It should be included in any test file that needs database access.
 *
 * Usage:
...
if (!$db) {
    ...
    // For test scripts, we'll throw an exception
